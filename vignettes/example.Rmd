...
We start by generating a coalescent tree with 10 leaves sampled in 2000, 10 leaves sampled in 2010, and
a reciprocal coalescent rate of 50:
...
res=roottotip(obsphy,dates,showPredInt='gamma',showTree=T)
```
