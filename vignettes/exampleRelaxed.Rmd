---
title: "Example of using BactDating with relaxed clock model"
...
```{r}
res=bactdate(obsphy,dates,model='mixedgamma',updateRoot=F)
plot(res,'trace')
print(res$pstrict)
```
...
```{r}
res=bactdate(obsphy,dates,model='mixedgamma',updateRoot=F,nbIts=1e6)
plot(res,'trace')
print(res$pstrict)
```
